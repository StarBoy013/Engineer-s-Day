...
export const challengeEvents: ChallengeEvent[] = [
  ...
  },
  {
    ...
    description: "Solve a real-world problem using AI by crafting effective prompts and developing an innovative AI-powered solution.",
    icon: "devices",
    isTeamEvent: false,
  },
  {
    ...
    description: "Build an engaging game from the ground up, combining creativity, logic, and technical skills to deliver a playable experience.",
    icon: "devices",
    isTeamEvent: false,
  },
  {
    id: "04",
    title: "Poster Making",
    description: "Visually communicate innovative engineering concepts, sustainability ideas, and future technology trends on a creative poster.",
    icon: "palette",
    isTeamEvent: false,
  },
  {
    ...
    description: "A fast-paced quiz testing engineering knowledge, logical reasoning, and problem-solving skills across various domains.",
    icon: "quiz",
    isTeamEvent: true,
  },
  {
    id: "06",
    title: "Reel Making",
    description: "Create short, engaging videos showcasing engineering creativity, event moments, and the spirit of innovation.",
    icon: "movie",
    isTeamEvent: true,
  },
];
